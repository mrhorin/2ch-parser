...
var _iconvLite = __webpack_require__(11);
...
var _thenRequest = __webpack_require__(5);
...
var _post_parser = __webpack_require__(8);
  ...
  _createClass(Thread, [{
    ...
    value: function _getNewPostsFromShitarabaPromise() {
      ...
      return new Promise(function (resolve, reject) {
        (0, _thenRequest2.default)('GET', reqUrl, { 'timeout': 15000 }).done(function (res) {
          res.url = reqUrl;
          if (res.statusCode == 200 && res.body.byteLength > 0) {
            ...
            res.body = _post_parser2.default.parseDat(res.body, _this.url);
    ...
    value: function _getNewPostsByRangePromise() {
      ...
      return new Promise(function (resolve, reject) {
        (0, _thenRequest2.default)('GET', _this2.datUrl, {
          'timeout': 15000,
          'headers': {
            'If-Modified-Since': _this2.headers.lastMofied,
            'Range': 'bytes=' + _this2.headers.contentLength + '-'
          }
        }).done(function (res) {
          res.url = _this2.datUrl;
          ...
          if (res.statusCode == 206) {
            ...
            res.body = _post_parser2.default.parseDat(res.body, _this2.url);
    ...
    get: function get() {
      ...
      return new Promise(function (resolve, reject) {
        (0, _thenRequest2.default)('GET', _this3.datUrl, { timeout: 15000 }).done(function (res) {
          res.url = _this3.datUrl;
          if (res.statusCode == 200) {
            // レスポンスヘッダ保存
            _this3.headers.lastMofied = res.headers['last-modified'];
            _this3.headers.contentLength = Number(res.headers['content-length']);
            _this3.posts = res.body = _post_parser2.default.parseDat(res.body, _this3.url);
            _this3._setPostsNo();
            _this3._setTitle();
            resolve(res);
          } else {
...
module.exports = function () {
  ...
  _createClass(PostParser, null, [{
    ...
    value: function parseDat(dat, threadUrl) {
      ...
      // UTF-8に
      var code = _url_parser2.default.isShitaraba(threadUrl) ? 'EUC-JP' : 'Shift_JIS';
      dat = _decoder2.default.convert(dat, code);
      return dat.split("\n").map(function (line) {
...
var assertion = __webpack_require__(23);
...
var should = __webpack_require__(27);
exports.use(should);
