...
describe('UrlParser', function () {
  ...
  describe('#isShitaraba', function () {
    ...
    it(url.thread.livedoor + ' is true.', function () {
      _chai.assert.isOk(_url_parser2.default.isShitaraba(url.thread.jbbs), url.thread.jbbs + ' is ok.');
    });
  ...
  describe('#getBoardUrl', function () {
    ...
    it('In case of ' + url.thread.sc + ' returns ' + url.board.sc + '.', function () {
      _chai.assert.equal(_url_parser2.default.getBoardUrl(url.thread.sc), url.board.sc);
    });

    it('In case of ' + url.thread.livedoor + ' returns ' + url.board.jbbs + '.', function () {
      _chai.assert.equal(_url_parser2.default.getBoardUrl(url.thread.livedoor), url.board.livedoor);
    });
  });
