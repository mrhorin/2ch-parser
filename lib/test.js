...
module.exports = function () {
  ...
  _createClass(Thread, [{
    ...
    get: function get() {
      ...
      return new Promise(function (resolve, reject) {
        (0, _superagent2.default)('GET', _this4.datUrl, { timeout: 15000 }).done(function (res) {
          res.url = _this4.datUrl;
          if (res.statusCode == 200) {
            // レスポンスヘッダ保存
            _this4.headers.lastMofied = res.headers['last-modified'];
            _this4.headers.contentLength = Number(res.headers['content-length']);
            _this4.posts = res.body = PostParser.parseDat(res.body, _this4.url);
            _this4._setPostsNo();
            _this4._setTitle();
            resolve(res);
          } else {
...
describe('Thread', function () {
  ...
  describe('#fetchNewPosts', function () {
    it('StatusCode is 200 in case of shitaraba thread URL.', function (done) {
      var jbbs = new _thread2.default("http://jbbs.shitaraba.net/bbs/read.cgi/internet/22724/1495859179/");
      jbbs.fetchNewPosts(function (res) {
        _chai.assert.isTrue(true, 'statuCode is 200');
        done();
      });
    });
