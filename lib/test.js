  ...
  _createClass(Thread, [{
    ...
    value: function _getNewPostsFromShitarabaPromise() {
      ...
      return new Promise(function (resolve, reject) {
        _superagent2.default.get(reqUrl).charset('euc-jp').timeout(2000).end(function (err, res) {
          if (err) {
            reject(err);
          } else {
    ...
    value: function _getNewPostsByRangePromise() {
      ...
      return new Promise(function (resolve, reject) {
        _superagent2.default.get(_this2.datUrl).charset('shift_jis').timeout(2000).set({ 'If-Modified-Since': _this2.headers.lastMofied, 'Range': 'bytes=' + _this2.headers.contentLength + '-' }).end(function (err, res) {
          if (err) {
            reject(err);
          } else {
    ...
    get: function get() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _superagent2.default.get(_this4.datUrl).charset(charCode).timeout(2000).then(function (err, res) {
          if (err) {
            reject(err);
          } else {
            switch (res.statusCode) {
...
describe('Thread', function () {
  ...
  describe('#newPostsPromise', function () {
    ...
    it('Error code is ENOTFOUND in case of invalid URL.', function (done) {
      var invalid = new _thread2.default("http://xxxxxxxxxxxxx.xxx.epcviewer");
