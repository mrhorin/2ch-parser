  ...
  _createClass(UrlParser, null, [{
    ...
    value: function getBoardUrl(url) {
      ...
      if (this.isShitaraba(url)) {
        ...
        if (_cgiIndex >= 0) {
          return uri[0] + "//" + uri[_cgiIndex - 2] + "/" + uri[_cgiIndex + 1];
        } else {
          return this.convertUrl(url);
        }
      }
...
var _url_parser = __webpack_require__(2);
...
__webpack_require__(14)(_superagent2.default);
...
var _chai = __webpack_require__(16);
